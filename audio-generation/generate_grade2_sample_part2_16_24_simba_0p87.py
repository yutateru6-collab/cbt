...
OUTPUT_DIR = ROOT / "audio-generation/grade2-sample-part2-16-24-simba-0p87-20260720"
PUBLISH_DIR = ROOT / "audio-generation/cloudflare-publish/grade2-sample-part2-16-24-simba-0p87-20260720"
RANGE_WORKER = source.RANGE_WORKER

NUMBERS = tuple(range(16, 25))
RATE = "-13%"
SPEED_LABEL = "0.87倍"
HUGH = source.HUGH
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Generate Grade 2 sample Part 2 No.16-24 at 0.87x with "
...
def configure_base() -> None:
    ...
    base.PART2_VOICE_PLANS = {
        number: {
            "body": base.GEFFEN if number <= 20 else base.DOMINIC,
            "narrator": HUGH,
        }
    ...
    base.MAX_TOTAL_INPUT_CHARACTERS = 15000
    base.AUDIO_CACHE_VERSION = "20260720-sample-part2-16-24-0p87"
...
<head>
  ...
  <title>英検2級 サンプル問題 Part 2 No.16-24｜Simba 0.87倍</title>
  <style>
...
<body><main>
  <h1>英検2級 サンプル問題<span>Part 2・No.16〜24</span></h1>
  <p class="lead">No.16〜20はGeffen、No.21〜24はDominic、問題番号・Question・設問はHughです。各問の本文全体を1回で生成し、文単位に切っていません。</p>
...
def main() -> int:
    ...
    report["rateOverrideReason"] = "Approved Part 2 production speed at 0.87x"

  ...
  window.scbtPre1ReadingContentSets = [
    ...
    makeSet("set-02", "第2回", [
      makePage(
        ...
        [
          "Bicycles in the late nineteenth century did not all resemble those used today. One famous design had an enormous front wheel with pedals attached directly to it and a much smaller rear wheel. A large wheel traveled farther with each turn of the pedals, allowing skilled riders to move quickly. The wheel’s size was limited by the rider’s leg length. It also placed riders high above the ground. If the front wheel struck a stone or stopped suddenly, they could be thrown forward and seriously injured. Mounting and stopping required practice, which limited the machine’s appeal. Three-wheeled cycles and lower two-wheeled models existed, but they were often heavy or slow. Designers continued searching for a bicycle that combined speed with greater stability.",
          "The key development was a chain that transferred power from the pedals to the rear wheel. Gears made it possible for a turn of the pedals to drive the wheel farther, so the front wheel no longer had to be exceptionally large. With two wheels of similar size, the rider sat lower and could touch the ground more easily. The new design became known as the safety bicycle. Air-filled tires later made rides smoother than solid rubber tires had, while improvements in metal production allowed factories to make lighter frames in larger numbers. Better brakes and guards around moving parts made the machines more manageable, although early versions were still expensive. Competition and mass production gradually lowered prices. By the 1890s, these changes had transformed the bicycle from a specialized machine for daring riders into practical personal transportation.",
    ...
    makeSet("set-03", "第3回", [
      makePage(
        ...
        [
          "In places with clear growing seasons, many trees add a visible ring of wood each year. A wide ring may indicate favorable conditions, while a narrow one may reflect drought, cold, insect damage, or competition from neighboring trees. The relationship is not as simple as “wide means wet,” because different species and locations respond to different factors. Scientists who study tree rings, called dendrochronologists, use a hollow drill to remove a thin core from a living tree without cutting it down. The sequence of wide and narrow rings in the core forms a pattern. An individual ring becomes meaningful when that pattern is compared with patterns from other trees.",
          "This comparison is known as crossdating. Suppose several trees show an unusually narrow ring followed two years later by an unusually wide one. A piece of older timber with the same sequence can be aligned with them even if its outermost rings are missing. By overlapping living trees, dead logs, and wood used in old buildings, researchers can construct continuous chronologies extending far beyond the lifetime of any one tree. If the date when a building was constructed is known, its timbers can strengthen a regional sequence; in return, that sequence can help date an unknown structure. These records have also revealed periods of severe drought. Rings can contain chemical evidence, and a major volcanic eruption may affect growth across a wide region, helping researchers connect environmental events recorded in different places.",
    ...
    makeSet("set-04", "第4回", [
      makePage(
        ...
        [
          "A five-minute wait does not always feel like five minutes. Studies of services have repeatedly shown that uncertainty, anxiety, and a lack of activity can make time seem longer. A passenger who knows that a train will arrive in eight minutes may feel calmer than one who has already waited three minutes with no information. Unexplained delays also seem less fair because people cannot tell whether they have been forgotten or whether someone else has received special treatment. Service managers therefore distinguish between actual waiting time and perceived waiting time. Reducing the first requires more staff, vehicles, or equipment, but improving the second may depend on communication and the way a queue is organized.",
          "Queue design can influence both fairness and experience. A single line leading to several service desks ensures that the next available worker takes the person who has waited longest. Separate lines appear shorter but may move at different speeds and leave customers regretting their choice. Visible progress matters too. Airports show stages in security lines, and repair companies give arrival windows or updates when a technician is delayed. Some businesses provide menus or forms while customers wait, allowing useful preparation to begin. Mirrors, displays, or a view of employees can also signal that progress is being made. These methods do not make the queue disappear, but they replace empty, uncertain time with information or activity. Estimates must be credible; an inaccurate promise can create more frustration than no estimate at all.",
      ...
      makePage(
        ...
        [
          "Cards and mobile payments have become common because they are fast and convenient. A shop can avoid handling coins, reduce the amount of money kept on the premises, and connect each sale automatically to its accounting system. Digital records may help households follow spending and allow lenders to evaluate people who previously had little formal financial history. Merchants, however, pay transaction fees and may face delayed payments or disputes over whether a charge was authorized. Governments also see electronic transactions as a way to reduce unreported business activity. These mixed but substantial advantages have led some companies to stop accepting cash and some observers to predict that physical money will eventually disappear.",
          "A cashless system, however, does not serve everyone equally. Opening and maintaining a bank account may require identification, a stable address, a minimum balance, or fees that some people cannot manage. Older adults and people with certain disabilities may find unfamiliar devices difficult to use, especially when an interface changes. Children, recent migrants, and victims leaving controlling households can depend on cash because it works without an account shared with another person. Cash permits a private gift or purchase without generating a permanent commercial record. Every digital payment, by contrast, creates data. Even when a purchase is legal and ordinary, customers may not want a company or payment provider to build a detailed picture of where and how they spend money.",
          ...
          "Policy responses increasingly try to preserve choice while extending digital access. Some cities require essential businesses to accept cash. Banks and governments can offer low-cost accounts, accessible payment cards, or systems that work temporarily offline. Consumer rules can restrict misuse of transaction data and clarify who bears a loss after fraud. Financial education helps only if products are affordable and easy to use. At the same time, maintaining cash requires machines, transport, and enough participating shops to keep the network. If each business assumes that another will preserve the system, access can vanish surprisingly quickly. The debate should therefore not be reduced to whether technology is good or bad. The more useful question is how to gain the efficiency of electronic payments without removing privacy, independence, and a reliable means of exchange from people who need them.",
        ],
        [
          makeQuestion(
            28,
    ...
    makeSet("set-05", "第5回", [
      makePage(
        ...
        [
          "In mountainous or densely forested regions, spoken words may not travel far, but a whistle can remain clear across a valley. Some communities have developed whistled forms of their everyday languages for communication over such distances. These are not independent codes with a few fixed signals. Speakers transform important sound patterns of the local spoken language into changes in pitch, length, and rhythm. In a language where pitch distinguishes words, whistles can reproduce those pitch movements. In other languages, whistlers may use shifts in pitch and interruptions of the sound to represent vowels and consonants. The method depends on the structure of the language being whistled.",
      ...
      makePage(
        ...
        [
          "As climates change, the temperature and rainfall suitable for a species may shift toward higher latitudes or elevations. In an unbroken landscape, plants and animals can sometimes move gradually as generations reproduce in new places. The pace differs greatly: a mobile insect may expand quickly, while a tree population advances only as seeds establish beyond its current edge. Roads, cities, farms, and isolated reserves can block that movement. Some conservationists therefore propose assisted migration: deliberately moving organisms to areas where future conditions may be better. The idea ranges from transferring a population within its historical range to introducing a species into a region where it has never lived. The farther the move, the greater both the possible benefit and the controversy.",
          "Supporters argue that waiting for visible population collapse may leave too little time. Long-lived trees, for example, reproduce and spread slowly, while the climate around them may change substantially within one generation. Moving seeds from warmer parts of a species’ range into cooler forests could add genetic traits already adapted to heat. Researchers keep records of each seed source because populations from different places may respond differently despite belonging to the same species. Small experimental plantings can compare survival, growth, and reproduction without immediately relocating an entire population. Assisted movement may also be considered when a rare species is trapped on a mountaintop or island and has no connected habitat into which it can naturally expand.",

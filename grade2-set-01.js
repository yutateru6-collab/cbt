window.scbtGrade2Set01 = {
  "grade": "grade2",
  "setId": "grade2-set-01",
  "sourceNote": "Original Eiken Grade 2-style practice set. Reading imported from user-provided Word file: grade 2 reading set 01.",
  "readingPages": [
    {
      "label": "短文語句",
      "kind": "choice",
      "instruction": "空所に入る最も適切な語句を選びなさい。",
      "passageTitle": "",
      "passage": [],
      "questions": [
        {
          ...
          "correct": 3,
          "explanation": "文脈から「symptom」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 2,
          "section": "短文語句",
          ...
          "correct": 1,
          "explanation": "文脈から「credible」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 3,
          "section": "短文語句",
          "type": "vocabulary",
          "text": "(3) During a museum workshop, visitors learned why old photographs should be kept away from strong sunlight. The main goal is to (　　　) the colors before they fade.",
          "choices": [
            "measure",
            "arrange",
            "display",
          ...
          "correct": 4,
          "explanation": "文脈から「preserve」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 4,
          "section": "短文語句",
          "type": "vocabulary",
          "text": "(4) A: Why is everyone entering the library from the side door today?\nB: The front entrance is closed (　　　) for safety checks, so it should open again tomorrow.",
          "choices": [
            "privately",
            "temporarily",
            "equally",
          ...
          "correct": 2,
          "explanation": "文脈から「temporarily」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 5,
          "section": "短文語句",
          "type": "vocabulary",
          "text": "(5) Before the plumber began fixing the kitchen sink, he told Mina his rough (　　　) for the job. He said the exact bill might be slightly different.",
          "choices": [
            "receipt",
            "discount",
            "estimate",
          ...
          "correct": 3,
          "explanation": "文脈から「estimate」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 6,
          "section": "短文語句",
        ...
        },
        {
          ...
          "correct": 1,
          "explanation": "文脈から「as long as」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        },
        {
          "id": 16,
          "section": "短文語句",
          "type": "phrase",
          "text": "(16) A: How did you meet the translator who helped with the brochure?\nB: It happened (　　　). We sat next to each other at a community event and started talking about local history.",
          "choices": [
            "in case",
            "at once",
            "for once",
        ...
        },
        {
          ...
          "correct": 2,
          "explanation": "文脈から「for the time being」が最も自然です。空所の前後関係と選択肢の意味を確認しましょう。"
        }
      ]
    },
    {
  ...
  "listeningQuestions": [
    {
      ...
      "choices": [
        "Visit the sales booths.",
        "Watch a piano concert.",
        "Look at student projects.",
        "Eat lunch at school."
      ],
      "correct": 3,
      "explanation": "女性は早く帰る必要があり、男性が先に学生の発表を見ることを提案しています。"
    },
    {
      "id": 2,
      "section": "第1部",
      ...
      "choices": [
        "Copy an article at the library.",
        "Return a book to his teacher.",
        "Go to a history class.",
        "Meet the girl at five."
      ],
      "correct": 1,
      "explanation": "サッカー練習後に図書館へ行き、本の中の記事をコピーするつもりです。"
    },
    {
      "id": 3,
      "section": "第1部",
      ...
      "choices": [
        "Order a different color.",
        "Make the sleeves shorter.",
        "Give the man a larger size.",
        "Send the jacket today."
      ],
      "correct": 2,
      "explanation": "女性は、今日買えば袖を無料で短くできると言っています。"
    },
    {
      "id": 4,
      "section": "第1部",
      ...
      "choices": [
        "He wanted to make the file smaller.",
        "His teacher told him to draw birds.",
        "He could not find clear photos.",
        "The girl asked him to use drawings."
      ],
      "correct": 3,
      "explanation": "オンラインで明確な写真を見つけられなかったため、自分で絵を描いたと言っています。"
    },
    {
      "id": 5,
      "section": "第1部",
      ...
      "correct": 2,
      "explanation": "道路工事でバスより電車の方が速いと女性が言っています。"
    },
    {
      "id": 6,
      "section": "第1部",
      ...
      "choices": [
        ...
        "He moved far from the shop.",
        "He wanted to work every evening.",
        "His uncle asked him to stop."
      ],
      "correct": 1,
      "explanation": "夜の勤務で勉強しにくかったため、コーヒー店の仕事をやめました。"
    },
    {
      "id": 7,
      "section": "第1部",
      ...
      "choices": [
        "It was made for a restaurant.",
        "It uses vegetables from a garden.",
        "It has already been sold at a festival.",
        "It was cooked by the teacher."
      ],
      "correct": 2,
      "explanation": "学校の庭で取れたにんじんを使っていると女性が言っています。"
    },
    {
      "id": 8,
      "section": "第1部",
      ...
      "choices": [
        "His mother had to leave early.",
        "He wanted to meet a friend.",
        "The dog was sick.",
        "He was training for a race."
      ],
      "correct": 1,
      "explanation": "母親が6時前に仕事へ出る必要があったので、代わりに犬の散歩をしました。"
    },
    {
      "id": 9,
      "section": "第1部",
      ...
      "choices": [
        ...
        "The museum is closed in the morning.",
        "Lunch is included in the price.",
        "The dentist will join the trip."
      ],
      "correct": 1,
      "explanation": "バスは朝ではなく正午に出発すると知りました。"
    },
    {
      "id": 10,
      "section": "第1部",
      ...
      "choices": [
        "Buy more paper.",
        "Clean part of the printer.",
        "Cancel the meeting.",
        "Change the ink again."
      ],
      "correct": 2,
      "explanation": "プリンター内部のガラスが汚れているかもしれないので、会議前に掃除すると言っています。"
    },
    {
      "id": 11,
      "section": "第1部",
      ...
      "choices": [
        "The movie starts earlier than the boy thought.",
        "The theater is far from them.",
        "The tickets were sold out last week.",
        "The previews have been canceled."
      ],
      "correct": 1,
      "explanation": "映画開始時刻が7時半ではなく7時に変更されていたことが問題です。"
    },
    {
      "id": 12,
      "section": "第1部",
      ...
      "choices": [
        "He washed food bowls.",
        "He played with cats all day.",
        "He gave medicine to animals.",
        "He trained new volunteers."
      ],
      "correct": 1,
      "explanation": "猫と遊ぶと思っていたが、主に食器を洗ったと言っています。"
    },
    {
      "id": 13,
      "section": "第1部",
      ...
      "choices": [
        "She won a bicycle race.",
        "She wrote an article about trash.",
        "She helped clean a river.",
        "She interviewed a reporter."
      ],
      "correct": 3,
      "explanation": "川の清掃活動の写真が新聞に載ったという内容です。"
    },
    {
      "id": 14,
      "section": "第1部",
      ...
      "choices": [
        "Buying bread from another shop.",
        "Freezing one loaf of bread.",
        "Coming back in the afternoon.",
        "Eating both loaves today."
      ],
      "correct": 2,
      "explanation": "1つを冷凍すれば数日新鮮に保てると提案しています。"
    },
    {
      "id": 15,
      "section": "第1部",
      ...
      "choices": [
        ...
        "The weather is too cold now.",
        "Students will use the road for exams.",
        "The bike path design is not finished."
      ],
      "correct": 3,
      "explanation": "2月に多くの生徒が試験会場へ行くためその道を使うので、工事を後にします。"
    },
    {
      "id": 16,
      "section": "第2部",
      ...
      "correct": 1,
      "explanation": "道具を借りる前にオンラインの安全動画を見る必要があります。"
    },
    {
      "id": 17,
      "section": "第2部",
      ...
      "choices": [
        "To help students care for shared spaces.",
        "To stop students from cleaning classrooms.",
        "To make teachers clean stairways.",
        "To shorten the school day."
      ],
      "correct": 1,
      "explanation": "皆が使う共有スペースへの責任感を持たせるためです。"
    },
    {
      "id": 18,
      "section": "第2部",
      ...
      "choices": [
        "People who cannot visit during the day.",
        "Artists who want to sell paintings.",
        "Children who need morning classes.",
        "Visitors without Internet access."
      ],
      "correct": 1,
      "explanation": "日中働いている人が訪れやすくするため、夜の無料チケットを用意しています。"
    },
    {
      "id": 19,
      "section": "第2部",
      ...
      "choices": [
        "Making memo pads from unused paper.",
        "Buying notebooks for classmates.",
        "Collecting exam papers after tests.",
        "Teaching students how to write notes."
      ],
      "correct": 1,
      "explanation": "ノートの未使用ページを切り取り、小さなメモ帳を作り始めました。"
    },
    {
      "id": 20,
      "section": "第2部",
      ...
      "choices": [
        "The platform for trains to Lake Town.",
        "The price of tickets to Central Station.",
        "The location of the ticket gates.",
        "The number of staff on trains."
      ],
      "correct": 1,
      "explanation": "Lake Town行きの列車が2番線ではなく4番線から出ることになります。"
    },
    {
      "id": 21,
      "section": "第2部",
      ...
      "choices": [
        "It uses rice flour from local farms.",
        "It is sold only to farmers.",
        "It becomes hard very quickly.",
        "It is made without any flour."
      ],
      "correct": 1,
      "explanation": "近くの農場の米粉を使ったパンである点が特徴です。"
    },
    {
      "id": 22,
      "section": "第2部",
      ...
      "choices": [
        "How the meaning of a word changed.",
        "Why newspapers stopped using prisons.",
        "How to write articles quickly.",
        "Why schools need more offices."
      ],
      "correct": 1,
      "explanation": "deadline という語の意味が、元の意味から現在の使い方へ変化したことを説明しています。"
    },
    {
      "id": 23,
      "section": "第2部",
      ...
      "choices": [
        "Helped customers choose sizes more accurately.",
        "Stopped selling shirts online.",
        "Opened a new return center.",
        "Asked customers to write longer comments."
      ],
      "correct": 1,
      "explanation": "手持ちの服と寸法を比べられるようにして、サイズ選びを助けています。"
    },
    {
      "id": 24,
      "section": "第2部",
      ...
      "choices": [
        "A nurse will explain a safety point.",
        "Residents will build a community hall.",
        "The club will sell sports shoes.",
        "The group will meet in the evening."
      ],
      "correct": 1,
      "explanation": "最初の散歩では看護師が運動中の脈拍確認について説明します。"
    },
    {
      "id": 25,
      "section": "第2部",
      ...
      "choices": [
        "Older residents enjoyed sharing memories.",
        "The town website could not show interviews.",
        "His history teacher disliked the project.",
        "Grandparents wanted shorter questions."
      ],
      "correct": 1,
      "explanation": "地域の高齢者が思い出を尋ねられることを楽しんでいると分かりました。"
    },
    {
      "id": 26,
      "section": "第2部",
      ...
      "choices": [
        "To encourage visitors to bring cups.",
        "To sell more paper cups.",
        "To make weekend tickets cheaper.",
        "To stop selling drinks."
      ],
      "correct": 1,
      "explanation": "使い捨てカップを減らすため、自分のカップを持参する人に割引をしています。"
    },
    {
      "id": 27,
      "section": "第2部",
      ...
      "choices": [
        "To encourage people to practice regularly.",
        "To compare users with professional speakers.",
        "To translate answers into other languages.",
        "To correct every pronunciation mistake."
      ],
      "correct": 1,
      "explanation": "グラフは発音を評価するためではなく、継続的な練習を促すためです。"
    },
    {
      "id": 28,
      "section": "第2部",
      ...
      "choices": [
        "Pictures and allergy-related ingredients.",
        "Train times near the station.",
        "The names of all tourists.",
        "Questions from children."
      ],
      "correct": 1,
      "explanation": "新しい表示には写真と、アレルギーの原因になりやすい材料の情報が含まれます。"
    },
    {
      "id": 29,
      "section": "第2部",
      ...
      "choices": [
        "They become dim when no one is nearby.",
        "They are turned off during winter.",
        "They use power from visitors' phones.",
        "They are cleaned by city workers."
      ],
      "correct": 1,
      "explanation": "人が近くにいない時に暗くなるため、電気を節約できます。"
    },
    {
      "id": 30,
      "section": "第2部",
      ...
      "choices": [
        "Students used leftover vegetables in it.",
        "It was the most difficult dish.",
        "Parents made it before class.",
        "The teacher bought it from a cafeteria."
      ],
      "correct": 1,
      "explanation": "生徒が学校食堂の残り野菜を使ったと説明したため、保護者に好評でした。"
    }
  ],
  "writingTasks": [
    {
  ...
  "speakingSteps": [
    ...
    },
    {
      ...
      "cardTitle": "Using Refill Stations",
      "cardText": "Some stores now have refill stations for soap, shampoo, and other daily products. Customers bring empty bottles and fill them again instead of buying new plastic containers. These stations can reduce waste and help people think about how they shop. However, stores must keep the machines clean and make the prices easy to understand.",
      "questionText": "According to the passage, how can refill stations reduce waste?",
      "pictureText": ""
    },
    {
      "label": "No.2",
      "seconds": 30,
      "prompt": "イラストの状況を説明します。",
      "visual": "カード",
      "recording": true,
      "cardTitle": "",
      "cardText": "",
      "questionText": "Please describe the situation.",
      "pictureText": "A student is holding an empty bottle at a refill station. A store clerk is showing the student how to use the machine, and another customer is waiting behind them."
    },
    {
      "label": "No.3",
      "seconds": 30,
      ...
      "cardTitle": "",
      "cardText": "",
      "questionText": "Do you think more people will choose products with less packaging in the future?",
      "pictureText": ""
    },
    {
      "label": "No.4",
      ...
      "cardTitle": "",
      "cardText": "",
      "questionText": "Do you think students should learn more practical skills at school?",
      "pictureText": ""
    }
  ]
};
